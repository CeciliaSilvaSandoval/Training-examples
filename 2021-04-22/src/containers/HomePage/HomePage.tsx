...
import OutboxDetail from '../../components/Outbox/OutboxDetail';
      ...
      return(
        <Layout  list={this.list}>
          ...
          <Switch>
            ...
            <Route path="/home/outbox" exact component={Outbox}></Route> 
            <Route path="/home/outbox/:id" exact component={OutboxDetail}></Route>
            {/* <Route path="/home/outbox/:id" exact render={()=><OutboxDetail/>}></Route>  */}
